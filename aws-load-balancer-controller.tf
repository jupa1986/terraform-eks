...
resource "aws_iam_role_policy_attachment" "aws-lb-controller" {
  ...
  role       = aws_iam_role.aws-lb-controller.name
}
...
resource "helm_release" "aws-load-balancer-controller" {
  ...
  version    = "1.7.2"
  namespace  = kubernetes_namespace.aws-load-balancer-controller.metadata[0].name

  values = [
    templatefile(
      "files/aws-load-balancer-controller.yaml",
      {
